...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::ai::fetch_provider_models,
            commands::ai::record_usage,
            commands::ai::get_usage_summary,
            commands::ai::clear_usage,
            commands::ai::get_skills,
            commands::ai::install_skill,
            commands::ai::uninstall_skill,
            ...
            commands::ai::import_existing_skill,
            ...
            commands::ai::scan_tool_sessions,
            commands::ai::upgrade_ai_tool,
            commands::ai::get_ai_tool_cache_info,
            commands::ai::migrate_ai_tool_cache,
            commands::ai::clean_ai_tool_cache,
            commands::ai::open_ai_tool_cache_dir,
            commands::ai::open_ai_tool_cache_dir_path,
            commands::ai::install_skill_from_online,
            commands::ai::scan_tool_sessions_parallel,
